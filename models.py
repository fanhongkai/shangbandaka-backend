...
#初始化数据
def init_tables():
    CompanyInfo.insert(loginName='admin',loginPwd='e10adc3949ba59abbe56e057f20f883e',companyName='优趣天下',Number=500,Legal='preson',RegistrationNum='xaxacsnih',CompanyPhone='18076598709',CompanyEmail='1425412316@qq.com',StatusId=True).execute()
    DepartmentInfo.insert(Name='技术部',Company=1,Phone='18076598709',Leader='王一').execute()
    EmployeesInfo.insert(Name='王八',LoginName='wangba',LoginPwd='e10adc3949ba59abbe56e057f20f883e',Company=1,Department=1,Sex='男',IdCard='452229199406235119',Phone='18777452591',Email='1425412316@qq',Position='员工',Imei='xacdcooccos',StatusId=True).execute()
    ManagerInfo.insert(LoginName='userAdmin',LoginPswd='e10adc3949ba59abbe56e057f20f883e',Name='李四',LastLoginData='2014-11-09 10:00:00',StatusId=True).execute()
    SignSetInfo.insert(Company=1,StartTime='8:00',EndTime='9:00',SignName='优趣天下',location='129,126',StatusId=True).execute()
    RegistrationInfo.insert(EmployeesId=1,Company=1,WorkStatus='正常上班',location='129,126',StatusId=True).execute()
    LeaveInfo.insert(EmployeesId=1,Company=1,StartTime='2014-11-09',PeriodTime='2014-11-10',EndTime='2014-11-11',Reason='请假过双11',ActTime='2014-11-09 10:00:00',reMsg='这样你也请假？',Agree=False,StatusId=True).execute()
...
class CompanyInfo(BaseModel):#公司信息
        ...
        StatusId=peewee.BooleanField(default=True)
...
class EmployeesInfo(BaseModel):#员工信息
        p_Id=peewee.PrimaryKeyField(default=1)
        Name=peewee.CharField(max_length=10)
