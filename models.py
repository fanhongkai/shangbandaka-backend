...
def init_tables():
    ...
    EmployeesInfo.insert(Name='王八',LoginName='wangba',LoginPwd='e10adc3949ba59abbe56e057f20f883e',Company=1,Department=1,Sex='男',IdCard='452229199406235119',Phone='18777452591',Email='1425412316@qq',Position='员工',Imei='xacdcooccos').execute()
