...
<html lang="en">
  <head>
    ...
    <link href="/assets/static/document.css" rel="stylesheet">
  ...
  <body style='padding-top:60px'>
    ...
    <div class="main" style='padding:20px 40px 20px 40px'>

        <h2 class='ml-not'>设置</h2>
        <div>
            <div class="bs-docs-example muted">
                表单一
            </div>
